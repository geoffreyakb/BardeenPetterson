...
r, Sigma, rho_mean, L, beta, gamma, LBH, betaBH, gammaBH, rho_Vr, rho_Vperp = READ_RADIAL_AVERAGE(n_average, n_r, spin, beta_0)
...
# Time
r_norm = 25         # cf. NP2000
t_orbit = 2*np.pi*(r_norm**1.5) / np.sqrt(1 - 2.5*epsilon**2)       # This is an input
...
pc0 = ax.pcolormesh(T, R, betaBH, cmap="berlin", vmin=0, vmax=buff)
